...
class REST
{
    ...
    function __construct($config = array())
    {
        ...
        */
        ...
        // $this->ci->load->config('configrest');
    ...
    {
        $this->rest_server = @$this->ci->config->item('server');
        ...
        /*isset($this->ci->config->item('send_cookies')) && */$this->send_cookies = $this->ci->config->item('send_cookies');
        
        /*isset($this->ci->config->item('api_name')) &&*/ $this->api_name = $this->ci->config->item('api_name');
        /*isset($this->ci->config->item('api_key')) &&*/ $this->api_key = $this->ci->config->item('api_key');
        
        /*isset($this->ci->config->item('http_auth')) &&*/ $this->http_auth = $this->ci->config->item('http_auth');
        /*isset($this->ci->config->item('http_user')) &&*/ $this->http_user = $this->ci->config->item('http_user');
        /*isset($this->ci->config->item('http_pass')) &&*/ $this->http_pass = $this->ci->config->item('http_pass');

        /*isset($this->ci->config->item('ssl_verify_peer')) &&*/ $this->ssl_verify_peer = $this->ci->config->item('ssl_verify_peer');
        /*isset($this->ci->config->item('ssl_cainfo')) &&*/ $this->ssl_cainfo = $this->ci->config->item('ssl_cainfo');
